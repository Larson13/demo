...
public class HttpClientUtils {
    ...
    public static void main(String[] args) throws IOException {
        String url = "http://localhost:8080/pinter/file/api/upload2";
        Map<String, String> fileMap = new HashMap<>();
        fileMap.put("file", "D:\\imsdk_report");
        HttpClientResponse response = HttpClientUtils.doPostFile(url, fileMap);
